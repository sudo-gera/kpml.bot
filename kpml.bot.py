...
class 10Б
class 6В
важно: использовать только русские буквы, а не их латинские аналоги
Потом нужно указать время оповещений:
примеры команды:
time 12:39
time 23:23
готово!
чтобы увмидеть остальные возможности бота введи other
для короткой справки введи faq
''')
