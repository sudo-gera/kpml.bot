...
if 1:
 ...
 for q in look():
  ...
  if q[1] == 'json':
   ...
   send('''Привет, это бот-оповещатель об изменениях в расписании. Чтобы подписаться на изменения напиши class потом перечисли все интересующие классы через символ ; Внимание: для указания буквы класса можно использовать только русские символы (не их латинские аналоги)
примеры команды:
class 9А;10В;1Б
class 10А
